class FileService
  ...
  def self.create_blob(file:, file_name:, file_extension: 'image/png')
  ...
  def self.attach_file(file:, file_name:, obj:, attachable_type:, file_extension: 'image/png')
    ...
    blob = self.create_blob(file: "tmp/#{file_name}.png", file_name: file_name, file_extension: file_extension)
