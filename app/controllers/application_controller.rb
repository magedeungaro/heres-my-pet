class ApplicationController < ActionController::Base
  ...
  after_action :verify_authorized, except: [:index, :mark_as_read, :notifications_counter], unless: :skip_pundit?
  after_action :verify_policy_scoped, only: [:index, :mark_as_read, :notifications_counter], unless: :skip_pundit?
